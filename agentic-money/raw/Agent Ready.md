---
title: "Agent Ready"
source: "https://docs.paypal.ai/growth/agentic-commerce/agent-ready"
author:
published:
created: 2026-04-26
description:
...
| `payment_provider.supported_payment_methods` | An array of payment methods that your Braintree integration supports. Current supported values are:   `card`   `applepay`   `googlepay` |
...
| `payment_provider.supported_payment_methods` | An array of payment methods that your Braintree integration supports. Available values are:   `card`   `applepay`   `googlepay`      Other options, including these, are coming soon:   `paypal_wallet`   `venmo_wallet` |
