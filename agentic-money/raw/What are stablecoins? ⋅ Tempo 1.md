---
title: "What are stablecoins? ⋅ Tempo"
source: "https://docs.tempo.xyz/learn/stablecoins"
author:
published:
created: 2026-04-21
...
![Mint and burn process for stablecoins](https://docs.tempo.xyz/learn/stablecoin-mint-burn-process.svg)
...
They support established use cases such as [remittances](https://docs.tempo.xyz/learn/use-cases/remittances), [global payouts](https://docs.tempo.xyz/learn/use-cases/global-payouts), and [embedded finance](https://docs.tempo.xyz/learn/use-cases/embedded-finance), while enabling newer applications like [microtransactions](https://docs.tempo.xyz/learn/use-cases/microtransactions) and [agentic commerce](https://docs.tempo.xyz/learn/use-cases/agentic-commerce).

![Stablecoin use cases](https://docs.tempo.xyz/learn/stablecoin-use-cases.svg)
...
On Tempo, stablecoins follow the [TIP-20 token standard](https://docs.tempo.xyz/protocol/tip20/overview), which adds transfer memos, compliance controls, and reward distribution to standard token functionality.

## Stablecoins on Tempo

Tempo is purpose-built for stablecoin payments and issuance. Key resources:

- [TIP-20 token standard](https://docs.tempo.xyz/protocol/tip20/overview): How stablecoins and other tokens behave on Tempo, including transfer memos and compliance policies
- [Native stablecoins](https://docs.tempo.xyz/learn/tempo/native-stablecoins): How Tempo approaches stablecoin design, settlement, and fee payment
- [Stablecoin DEX](https://docs.tempo.xyz/guide/stablecoin-dex): On-chain exchange for stablecoin-to-stablecoin swaps
- [Mint stablecoins](https://docs.tempo.xyz/guide/issuance/mint-stablecoins): Create custom stablecoins with built-in compliance features
...
Stablecoins enable a wide range of payment and financial use cases:[Remittances](https://docs.tempo.xyz/learn/use-cases/remittances)

[

Enable fast, cheap, and predictable cross-border money transfers for individuals and businesses

](https://docs.tempo.xyz/learn/use-cases/remittances)[

Global Payouts

Deliver instant, low-cost payouts to employees and contractors anywhere in the world

](https://docs.tempo.xyz/learn/use-cases/global-payouts)[

Embedded Finance

Let platforms and marketplaces embed seamless payment flows directly into their applications

](https://docs.tempo.xyz/learn/use-cases/embedded-finance)[

Tokenized Deposits

Move treasury liquidity instantly across borders with real-time visibility into global cash positions

](https://docs.tempo.xyz/learn/use-cases/tokenized-deposits)[

Microtransactions

Enable true pay-per-use pricing with sub-cent payments for APIs, content, and IoT services

](https://docs.tempo.xyz/learn/use-cases/microtransactions)[

Agentic Commerce

Power autonomous agents with programmable payments for goods, services, and digital resources

](https://docs.tempo.xyz/learn/use-cases/agentic-commerce)
...
[Suggest changes to this page](https://github.com/tempoxyz/docs/edit/main/src/pages/learn/stablecoins.mdx)

Last updated: 01/29/2026, 06:20 PM