...
## Acquisitions (strategic stack-building)

- **Bridge** (acquired ~2025) — stablecoin infrastructure
- **Privy** (acquired ~2025/2026) — wallet and auth infrastructure for crypto-native products

These acquisitions signal Stripe's thesis: consolidation plays to secure key pieces of the new financial infrastructure stack before it settles. — *[[the-new-stack-for-global-finance-stablecoins]]*
